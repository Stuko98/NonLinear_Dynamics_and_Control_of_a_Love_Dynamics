...
%exportgraphics(fig, 'x_P2_phase_plane_nl_lin_ref.pdf');
...
grid on
box on
%exportgraphics(fig, 'y_x2_nl_lin_ref.pdf');
...
grid on
box on 
%exportgraphics(fig, 'u_nl_lin_ref.pdf');
...
grid on
box on 
%exportgraphics(fig, 'e_nl_lin_ref.pdf');
